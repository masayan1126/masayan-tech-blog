 ...
 * 【用途】下書きプレビュー専用
 *
 * このAPIエンドポイントは、下書きプレビュー時にリンクカードを表示するために使用されます。
 * 本番環境では、microCMS側でリンクカードが展開されるため、このAPIは使用されません。
 *
 * 使用箇所:
 * - src/features/LinkCard/LinkCard.tsx
 * - src/pages/blog/draft/index.astro
 */
